 ...
 */
public class DefaultCreateZipEvent extends CreateZipEvent
{
    ...
    public DefaultCreateZipEvent(Object i_Source) 
    {
        super(i_Source);
    }
    ...
    public DefaultCreateZipEvent(Object i_Source ,long i_FileSize) 
    {
    ...
    public void setPerSource(CreateZipEvent i_PerSource)
    {
